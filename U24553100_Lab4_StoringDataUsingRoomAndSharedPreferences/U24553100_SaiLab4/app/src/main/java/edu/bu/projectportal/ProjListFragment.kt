...
class ProjListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.projlist?.apply{
            ...
            adapter = if(binding.projListFavId.isChecked) MyProjListRecyclerViewAdapter(projectDao.getFavProjects()) else MyProjListRecyclerViewAdapter(projectDao.getAllProjects())
        }
        ...
        binding.projListFavId.setOnClickListener {
            binding.projlist.adapter = if(binding.projListFavId.isChecked) MyProjListRecyclerViewAdapter(projectDao.getFavProjects()) else MyProjListRecyclerViewAdapter(projectDao.getAllProjects())
